// verify: debug ok
// Listing 17.6-6 (debugging exercise): listing 17.6-3 with ONE change: the must-analysis starts from
// the empty set ("bottom") instead of the full set ("top"). Compare its report on sum_to with 17.6-3.
// Original header of 17.6-3: two classic dataflow analyses on a CFG, solved by iterating to a fixpoint.
